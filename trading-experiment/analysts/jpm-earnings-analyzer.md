...
### 2. Consensus + guidance for the upcoming quarter (Q2 FY2027, reports 8/26)
...
- **Street consensus:** Revenue ~$91-91.7B (essentially in line with the guide); EPS ~$2.01-2.07.
- No change to consensus figures found this run.
...
Beat magnitude has shrunk sharply since Q2 FY2026's outsized +12% EPS beat, even as revenue growth accelerated 21%→26% YoY. Unchanged this run.

### 2. Consensus + guidance for the upcoming quarter (fiscal Q2 FY2027, reports 8/26)
- **CrowdStrike's own guide (6/3/26):** Revenue $1.43-1.44B; non-GAAP operating income $346-349M; non-GAAP diluted EPS $1.16-1.17; ARR $5,792.6-5,794.6M.
- **Street consensus:** Revenue ~$1.43B; EPS ~$1.15 — at/slightly below the low end of the company's own guide.
- No change found this run.

### 3. Key metrics to watch this print
- **Net new ARR** — Q1 FY27 posted a record $256M (+32% YoY); watch whether the ~$280M+ implied Q2 pace holds.
...
- **Module adoption** — 8+ module customers at 25% of the base as of Q1 FY27; the number most likely to move the stock on a beat.
- **Falcon Flex customer count** — still a known data gap (last disclosed figure 1,000+, from Q2 FY26); confirm from the print.
- **2024 outage overhang** — appears fully metabolized (97% gross retention every quarter of FY26); watch for residual commentary only.
...
|---|---|---|
| 2026-06-03 | Q1 FY2027 | **-9% to -11%** next session (sources conflict) despite beating both lines — "worst drop in 22 months," driven by only in-line guidance |
...
| 2025-06-03 | Q1 FY2026 | not re-verified this run; carried from prior brief as directionally positive |
